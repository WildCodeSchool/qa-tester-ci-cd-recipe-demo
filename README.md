# 🍰 Atelier CI/CD — Recette magique

Bienvenue dans cet atelier d’introduction à l’intégration et livraison continues (CI/CD) avec GitHub Actions et GitHub Pages.
